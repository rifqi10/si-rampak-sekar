...
<body class="bg-white">
    ...
    <main>
        ...
        <!--Card-->
        <p class="h-16 mt-2 mb-8 overflow-hidden text-center text-gray-600 line-clamp-3">
        ...
        <div class="flex flex-wrap py-8 mb-8 bg-white">
        ...
        <!-- Additional Sections -->
        <div class="container px-4 py-8 mx-auto mb-8">
                ...
                <div class="md:w-1/2 md:pl-8">
                    ...
                    <div id="sipd" class="tab-content">
                        <div class="flex flex-row items-center">
                            <div class="w-1/2">
                                <img src="{{ asset('img/SIPD.png') }}" alt="SIPD" class="h-auto max-w-full mb-4 md:max-w-lg">
                            </div>
                            <div class="ml-8">
                                <p class="mb-4">
                    ...
                    <div id="sipd-ri" class="hidden tab-content">
                        <div class="flex flex-row items-center">
                            <div class="w-1/2">
                                <img src="{{ asset('img/SIPD RI.png') }}" alt="SIPD RI" class="h-auto max-w-full mb-4 md:max-w-lg">
                            </div>
                            <div class="ml-8">
                                <p class="mb-4">
            ...
            <div class="flex flex-col items-center mb-8 md:flex-row">
                <div class="order-last md:w-1/2 md:order-first md:pr-8">
                    ...
                    <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                        <ul class="flex flex-wrap -mb-px">
                            <li class="me-2">
                                <a href="#" class="inline-block p-4 font-bold text-green-600 border-b-2 border-green-600 rounded-t-lg tab-link active dark:text-green-500 dark:border-green-500" data-tab="keuangan-sipd" aria-current="page">SIPD</a>
                            </li>
                            <li class="me-2">
                                <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg tab-link hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" data-tab="keuangan-laporan">SIPD RI</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div id="keuangan-laporan" class="hidden tab-content">
                        <div class="flex flex-row items-center">
                            <div class="w-1/2">
                                <img src="{{ asset('img/SIPD.png') }}" alt="Laporan Keuangan" class="h-auto max-w-full mb-4 md:max-w-lg">
                            </div>
                            <div class="ml-8">
                                <p class="mb-4">
                                    Aplikasi nasional yang dikembangkan untuk membantu pemerintah daerah di Indonesia dalam
        ...
        <div class="container px-4 py-8 mx-auto mb-8">
            <div class="flex flex-col items-center mb-8 md:flex-row">
                <div class="md:w-1/2">
                    <img src="{{ asset('img/pengelolaan.png') }}" alt="Monitoring Evaluasi dan Pengendalian" class="w-full h-auto mb-4">
                </div>
                <div class="md:w-1/2 md:pl-8">
                    ...
                    <div class="text-sm font-medium text-center text-gray-500 border-b border-gray-200 dark:text-gray-400 dark:border-gray-700">
                        <ul class="flex flex-wrap -mb-px">
                            <li class="me-2">
                                <a href="#" class="inline-block p-4 font-bold text-green-600 border-b-2 border-green-600 rounded-t-lg tab-link active dark:text-green-500 dark:border-green-500" data-tab="monev-emonev" aria-current="page">E-Monev</a>
                            </li>
                            <li class="me-2">
                                <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg tab-link hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" data-tab="monev-laporan">Bantuan Keuangan</a>
                            </li>
                            <li class="me-2">
                                <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg tab-link hover:text-gray-600 hover:border-gray-300 dark:hover:text-gray-300" data-tab="monev-analisis">Hibah Bansos</a>
                            </li>
                        </ul>
                    </div>
                    <div id="monev-emonev" class="tab-content">
                        <div class="flex flex-row items-center">
                            <div class="w-1/2">
                                <img src="{{ asset('img/e-monev.png') }}" alt="e-Monev" class="h-auto max-w-full mb-4 md:max-w-lg">
                            </div>
                            <div class="ml-8">
                                <p class="mb-4">
                    ...
                    <div id="monev-laporan" class="hidden tab-content">
                        <div class="flex flex-row items-center">
                            <div class="w-1/2">
                                <img src="{{ asset('img/bantuan keuangan.png') }}" alt="Laporan Evaluasi" class="h-auto max-w-full mb-4 md:max-w-lg">
                            </div>
                            <div class="ml-8">
                                <p class="mb-4">
                    ...
                    <div id="monev-analisis" class="hidden tab-content">
                        <div class="flex flex-row items-center">
                            <div class="w-1/2">
                                <img src="{{ asset('img/sipd.png') }}" alt="Analisis Data" class="h-auto max-w-full mb-4 md:max-w-lg">
                            </div>
                            <div class="ml-8">
                                <p class="mb-4">
        ...
        <div class="container px-4 py-8 mx-auto mb-8">
            ...
            <p class="text-center">Dapatkan kemudahan akses ke beberapa layanan SI RAMPAK SEKAR!</p>
    ...
    <!-- Footer Section -->
    <footer class="py-12 mb-8 text-white bg-green-800">
        <div class="container mx-auto text-center">
            <div class="flex items-center justify-center">
                <img src="{{ asset('img/logo_footer.png') }}" alt="Logo_footer" class="h-12">
                <span class="ml-4 text-lg font-semibold">SI RAMPAK SEKAR</span>
            </div>
    ...
    <!-- Our Client -->
    <div class="mt-12 mb-8 text-center">
            <h2 class="mb-4 text-2xl font-bold">Our Client</h2>
            <p class="mb-8">
            ...
            <div class="flex justify-center space-x-8">
                ...
                <img src="{{ asset('img/logo4.png') }}" alt="Logo ba" class="logo">
                <img src="{{ asset('img/logo3.png') }}" alt="Logo Diskominfo" class="logo">
                <img src="{{ asset('img/logo6.png') }}" alt="Logo 6" class="logo">
                <img src="{{ asset('img/logo7.png') }}" alt="Logo 7" class="logo">
                <img src="{{ asset('img/logo8.png') }}" alt="Logo 8" class="logo">
            </div>
        </div>
